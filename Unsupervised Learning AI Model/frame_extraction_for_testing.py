...
unconverted_data_directory = 'unconverted_data/Abnormal_Crowds_1'

testing_data_directory = 'testing_data'

cwd = os.getcwd()

extracted_frames_folder = cwd + "/extracted_frames_for_testing"
...
def convert_data(directory):
    ...
    for filename in os.listdir(directory):
        subprocess.run(['ffmpeg',
                        ...
                        '-qscale',
                        '0',
                        testing_data_directory + '/' + filename.split('.')[0] + '.mp4',
                        '-loglevel',
                        'quiet'])
...
load_video(testing_data_directory)
